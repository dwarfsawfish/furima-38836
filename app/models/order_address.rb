class OrderAddress
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, phone_number: phone_number, sender_address_id: sender_address_id, municipality: municipality, address: address, building: building, order_id: order.id)
  end
end